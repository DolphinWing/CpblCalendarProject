...
//        }
    ...
    private SparseArray<Palette> mTeamLogoPalette = new SparseArray<>();

    public void setTeamLogoPalette(int id, Palette palette) {
        //Log.d("CpblApp", String.format("set %d-%d", year, teamId));
        mTeamLogoPalette.put(id, palette);
    }

    public Palette getTeamLogoPalette(int id) {
