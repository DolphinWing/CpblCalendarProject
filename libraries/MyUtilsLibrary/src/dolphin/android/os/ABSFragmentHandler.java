...
public class ABSFragmentHandler extends Handler
{
	//Handlers and memory leaks in Android
	//http://stackoverflow.com/a/11336822

	private final WeakReference<ABSFragment> mFragment;
	...
	{
		return (ABSFragmentActivity) getFragment().getSherlockActivity();
	}

	public ABSFragmentHandler(ABSFragment fragment)
	{
		mFragment = new WeakReference<ABSFragment>(fragment);
	}
