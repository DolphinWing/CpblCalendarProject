...
public class ABSFragmentActivityHandler extends Handler
{
	...
	public ABSFragmentActivityHandler(ABSFragmentActivity activity)
	{
		mActivity = new WeakReference<ABSFragmentActivity>(activity);
	}
